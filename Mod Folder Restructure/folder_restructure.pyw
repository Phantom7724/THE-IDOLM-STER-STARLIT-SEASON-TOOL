...
def create_ui():
    ...
    # 开始按钮
    start_button = tk.Button(window, text="Start", command=lambda: restructure_folders(selected_directory))
    ...
    show_log_button = tk.Button(window, text="Log", command=show_logs)
